        ...
        public static object StringToObject(string endString)
        {
            ...
            if (assembly != null)
            {
                ...
                if (type != null)
                {
                    ...
                    var properties = type.GetProperties(System.Reflection.BindingFlags.NonPublic | BindingFlags.Public | BindingFlags.Instance);
                    for (int i = 3; i < str.Length - 1; i++)
                    {
                        ...
                        if (property != null)
                        {
                            ...
                            {
                                property.SetValue(obj, decimal.Parse(propertyValue.Trim()));
                            }
                            else if (property.PropertyType == typeof(char[]))
                            {
                                property.SetValue(obj, propertyValue.Trim().ToCharArray());
                            }
                        }
                    }
                    return obj;
